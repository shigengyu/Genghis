...
STATICFILES_DIRS = (
    ...
    os.path.join(GENGHIS_BASE_DIR, 'static', 'font'),
    os.path.join(GENGHIS_BASE_DIR, 'static', 'img'),
    os.path.join(GENGHIS_BASE_DIR, 'static', 'js'),
    os.path.join(GENGHIS_BASE_DIR, 'static', 'style'),
)
